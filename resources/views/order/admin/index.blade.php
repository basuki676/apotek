...
@section('content')
<div class="mt-5">
    <form action="{{ route('admin.order.searchAdmin') }}" method="get" class=" bg-light mt-5 p-5" style="border:1px solid lightgray; border-radius:1rem;">
        <div class="d-flex justify-content" >
            ...
            <a href="{{ route('admin.order.data') }}" class="btn btn-secondary" style="width: 100px;">Kembali</a>
        </div>  
        <div class="d-flex justify-content-end" style="margin-top: -2.9rem">
            <a href="{{ route('admin.order.download-excel') }}" class="btn btn-success"><i class="bi bi-cart-plus"></i> Export Excel</a>
        </div>
